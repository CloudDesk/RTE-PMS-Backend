...
export const TermWorkflowState = {
  ...
  EMPLOYEE_ACHIEVEMENT_OPEN: 'EMPLOYEE_ACHIEVEMENT_OPEN',
...
export const AnnualWorkflowState = {
  ...
  ALL_TERMS_FINALIZED: 'ALL_TERMS_FINALIZED',
...
export function isAllTermsFinalized(
  state?: AnnualWorkflowState | string | null,
): boolean {
  return state === AnnualWorkflowState.ALL_TERMS_FINALIZED;
}
...
export const WorkflowAction = {
  ...
  OPEN_EMPLOYEE_ACHIEVEMENT: 'OPEN_EMPLOYEE_ACHIEVEMENT',
...
export const PmsAuditAction = {
  ...
  TERM_REVIEW_SUBMITTED: 'PMS_TERM_REVIEW_SUBMITTED',
  TERM_FINALIZED: 'PMS_TERM_FINALIZED',
  TERM_REOPENED: 'PMS_TERM_REOPENED',
